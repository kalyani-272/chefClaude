...
export default function MainContent(){
        ...
        {ingredients.length>0 &&  <section>
            ...
            {ingredients.length>4 && <div className="get-recipe">
                <div>
                    ...
                    <p>Generate a recipe based on your available ingredients!</p>
                </div>
    ...
    <article className="suggested-recipe-container" aria-live="polite">
        <p>
            ...
            a simple and delicious <strong>Beef Bolognese Pasta</strong> recipe:
        </p>
        ...
        <ol>
            ...
            <li>
                ...
                for 3–5 minutes, until the onion is translucent.
            </li>
            <li>
                Stir in the tomato paste and cook for 1 minute.
            </li>
            <li>
                Add the crushed tomatoes, beef broth, oregano, salt, and pepper
                to taste.
            </li>
            <li>
                Reduce the heat to low and let the sauce simmer, stirring
